// Package keys provides pre-shared key constants for TROPIC01 pairing.
package keys

// SH0PrivEngSample is the host private key for engineering sample chips (slot 0).
var SH0PrivEngSample = [32]byte{
...
// SH0PubEngSample is the host public key for engineering sample chips (slot 0).
var SH0PubEngSample = [32]byte{
...
// SH0PrivProd0 is the host private key for production chips (slot 0).
var SH0PrivProd0 = [32]byte{
...
// SH0PubProd0 is the host public key for production chips (slot 0).
var SH0PubProd0 = [32]byte{
