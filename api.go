...
// GetCert reads the certificate store from TROPIC01 over an established
// L3 session. Returns the raw response bytes.
// Requires an active L3 session.
...
// Mirrors lt_mutable_fw_update in libtropic.h.
